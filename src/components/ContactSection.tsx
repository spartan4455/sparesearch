    ...
    <section id="contact" className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {/* Phone Card */}
          <div className="glass rounded-2xl p-6 sm:p-8 text-center hover-glow transition-all duration-500 hover:-translate-y-2">
        ...
        <div className="mt-16 text-center">
          <div className="glass-strong rounded-3xl p-6 sm:p-10 max-w-2xl mx-auto">
            ...
            <p className="text-muted-foreground mb-8">
              Connect with a research consultant instantly via WhatsApp for
              quick responses and real-time assistance.
            </p>
            ...
            <Button
              ...
              size="xl"
              asChild
              className="w-full sm:w-auto max-w-full whitespace-normal break-words h-auto min-h-12 px-4 sm:px-8 py-3"
            >
              <a
